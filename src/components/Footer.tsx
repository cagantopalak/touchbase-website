...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-white/[0.08] pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          {/* Brand Info */}
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-2xl bg-[#1c1c28] border border-white/10 flex items-center justify-center">
                <Image
                  src="/images/icon.png"
                  alt="TouchBase Logo"
                  width={24}
              ...
              <span className="px-2 py-0.5 rounded-full bg-[#00e5ff]/10 text-[10px] font-bold text-[#00e5ff] border border-[#00e5ff]/20">
                v1.0.0
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-zinc-400">
              ...
              <li>
                <a
                  href="https://github.com/cagantopalak/TouchBase"
                  target="_blank"
                  rel="noopener noreferrer"
